...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-zinc-50 to-zinc-100 dark:from-zinc-900 dark:to-black">
      ...
      <section id="tecnologias" className="py-20 px-4 bg-white dark:bg-zinc-800">
        <div className="max-w-6xl mx-auto">
          <ScrollReveal>
            <h3 className="text-3xl md:text-4xl font-bold text-center mb-12 text-zinc-800 dark:text-zinc-200">
              Tecnologías
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {technologies.map((tech, index) => (
              <ScrollReveal key={index} delay={index * 50}>
                <div
                  className="bg-white dark:bg-zinc-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-zinc-200 dark:border-zinc-700 group"
                >
