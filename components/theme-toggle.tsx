...
export function ThemeToggle() {
  ...
  return (
    ...
    >
      ...
      <span
        className={`pointer-events-none absolute inset-y-1 flex h-8 w-8 items-center justify-center rounded-full bg-yellow-400 text-zinc-950 transition-all duration-300 ${
          isDark
